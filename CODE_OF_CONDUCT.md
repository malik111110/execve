...
of acceptable behavior. Maintainers will take fair and appropriate corrective
...
- Use GitHub private vulnerability reporting if it is enabled for this
  repository.
- Contact a repository owner privately using the contact information on their
  GitHub profile.
...
Maintainers may follow these Community Impact Guidelines when determining
consequences:
